export const uk = {
        ...
        "how_it_works": {
            ...
            "steps": {
                "step2": {
                    ...
                    "desc": "Cтворіть свою команду з друзями для участі в турінрах."
                },
                "step3": {
                    "title": "Шлях до перемоги",
                    "desc": "Виконуйте завдання раундів, отримуйте бали від професійного журі та піднімайтеся на вершину таблиці лідерів і перемагайте в турнірах!"
                }
            }
        }
    },
    ...
    tournaments: {
        ...
        "admin": {
            ...
            "warn": "Турнір почнеться по закінченню реєстрації!"
        }
    },
    tournament_details: {
        "header": {
