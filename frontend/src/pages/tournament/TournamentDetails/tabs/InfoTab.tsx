                    ...
                    <Paper sx={{ p: 4, borderRadius: "24px", border: "1px solid #e0e0e0" }}>
                        <Stack spacing={3}>
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid size={{ xs: 6 }}><TextField fullWidth type="number" label={t("tournaments.admin.fields.rounds")} value={state.editFormData.countOfRounds} onChange={(e) => state.setEditFormData({ ...state.setEditFormData, countOfRounds: Number(e.target.value) })} /></Grid>
                            </Grid>
